...
interface ISnipeTable {
    ...
    handleEdit: any;
    handleDelete: any;
    handleImage: (snipe: ISnipe) => void;
}

export const SnipeTable = ({ snipes, handleAdd, handleEdit, handleDelete, handleImage }: ISnipeTable) => {
                            ...
                            >
                                ...
                                {showImages && (
                                    <td className='p-5 text-sm text-gray-700'>
                                        <img onClick={() => handleImage(snipe)} className='object-cover h-20 w-20 rounded hover:cursor-pointer select-none' src={snipe.image.url} />
                                    </td>
                                )}
